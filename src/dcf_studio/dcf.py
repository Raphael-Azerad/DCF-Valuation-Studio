...
def calculate_dcf(inputs: DCFInputs) -> DCFResult:
    ...
    The model uses the standard enterprise-value DCF structure: projected free cash flows are discounted at WACC,
    terminal value is estimated with Gordon Growth, then net debt is bridged from enterprise value to equity value.
    """
    ...
    # Gordon Growth terminal value: final forecast FCF grown into year n+1, capitalized by WACC less terminal growth.
    terminal_value = (
